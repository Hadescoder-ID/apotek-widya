            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="form-group col-md-6"> 
                            ...
                            <select data-live-search="true" class="form-control" title="Pilih Distributor" name="id_distributor" readonly> 
                                <?php foreach($distributor as $dataDistributor) : ?>
                                    <?php if($masuk1['id_distributor'] == $dataDistributor['id_distributor']) : ?>
                                        <option selected name="id_distributor" value="<?= $dataDistributor['id_distributor']; ?>" readonly><?= $dataDistributor['nama_distributor']; ?></option> 
                                    <?php else :?>        
                                        <option selected name="id_distributor" value="<?= $dataDistributor['id_distributor']; ?>" readonly><?= $dataDistributor['nama_distributor']; ?></option> 
                                    <?php endif; ?> 
                                <?php endforeach; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_masuk" value=" " class="form-control"  required>
                        </div>
                ...
                <div class="col">
                    <div class="form-group">
                            ...
                            <input type="text" name="batch" value="" class="form-control"  required>
                        </div>
                    <div class="form-group">
                        <label for="tgl_expired">Tanggal Expired :</label>
                        <input type="hidden" name="tgl_pesan" value="<?= $masuk1['tgl_pesan']; ?>" class="form-control" placeholder="Masukkan Harga Jual"  >
                        <input type="date" name="tgl_expired" value="<?= $masuk1['tgl_expired']; ?>" class="form-control" placeholder="Masukkan Harga Jual"  >
                    </div>
        
                    <div class="form-group">
                        <label for="keterangan">Keterangan :</label>
                        <input type="text" name="keterangan" value="Penambahan Stok Obat" class="form-control" placeholder="Masukkan Keterangan" readonly>
                    </div>
                </div>
            </div>
