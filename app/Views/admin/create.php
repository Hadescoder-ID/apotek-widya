            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-group">
                        ...
                        <input type="username" class="form-control" <?php if(session('errors.username')) : ?>is-invalid<?php endif ?>" name="username"
                                                placeholder="<?=lang('Auth.username')?>">
                    </div>
                    <div class="form-group">
                        <label for="nama_lengkap">Nama Lengkap :</label>
                        <input type="nama_lengkap" class="form-control" <?php if(session('errors.nama_lengkap')) : ?>is-invalid<?php endif ?>" name="nama_lengkap"
