        ...
        <div class="card-body">
            <form action="" method="post" id="text-editor">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <label for="tgl_expired">Tangal Expired :</label>
                        <input type="date" name="tgl_expired" class="form-control" placeholder="Masukkan Harga Jual" required>
                    </div>
                    <!-- <div class="form-group">
                        <label for="tgl_masuk">Tanggal Masuk :</label>
                        <input type="date" name="tgl_masuk" class="form-control" placeholder="Masukkan Harga beli" required>
                    </div> -->
                    <div class="form-group">
                        <label for="keterangan">Keterangan :</label>
                        <input type="text" name="keterangan" class="form-control" placeholder="Masukkan Harga beli" required>
                    </div>
                    </div>
                </div>
